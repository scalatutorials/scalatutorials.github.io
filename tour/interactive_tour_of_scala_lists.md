...
code: |
  ...
  val mlist = mutable.ArrayBuffer("a", "b", "c") //> mlist = ArrayBuffer(a, b, c)
  ...
  mlist --= List("e", "f") //> ArrayBuffer(d, b)
  mlist //> ArrayBuffer(d, b)
